...
public abstract class MotorIO {
  ...
  /**
   * Adds a new preset voltage. If the name already exists, the existing preset will be overwritten
   *
   ...
   * @throws RuntimeException Thrown if name does not exist in the preset voltage list
   */
