...
public class AngularMotorIO extends MotorIO {
  ...
  @AutoLog
  public static class AngularMotorInputs extends MotorIO.MotorInputs {
    public MutAngle position = Radians.mutable(0);
    public MutAngularVelocity velocity = RadiansPerSecond.mutable(0);
  }

  /**
   * Adds a new preset position. If the name already exists, the existing preset will be overwritten
   *
  ...
  /**
   * Adds a new preset velocity. If the name already exists, the existing preset will be overwritten
   *
   * @param name preset name
   ...
   * @throws RuntimeException Thrown if name does not exist in the preset position list
   */
