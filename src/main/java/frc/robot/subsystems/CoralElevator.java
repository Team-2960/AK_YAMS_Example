...
public class CoralElevator extends LinearMechanism {
    ...
    private final ElevatorFeedforward ff = new ElevatorFeedforward(0.22643, 0.33045, 4.4162, 0.32248);
    ...
    private final SparkFlex sparkFlex = new SparkFlex(Constants.coralElevMotorID, MotorType.kBrushless);
