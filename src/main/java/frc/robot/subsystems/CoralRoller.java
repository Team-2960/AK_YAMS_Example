...
public class CoralRoller extends LinearMechanism {
  ...
  private final SparkFlex sparkFlex =
      new SparkFlex(Constants.coralRollerMotorID, MotorType.kBrushless);
  ...
  /*****************************/
  /**
   * Get a command to automatically intake coral. Mechanism slows down when coral is detected in
